      ...
      <div className="flex flex-col items-center gap-8">
        ...
        <div className="text-center">
          <h2 className="text-2xl font-black tracking-wider mb-2" style={{
            ...
            <span className="bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 bg-clip-text text-transparent">L</span>
            <span className="bg-gradient-to-br from-purple-400 via-purple-500 to-purple-600 bg-clip-text text-transparent">E</span>
          </h2>
